    ...
    <div className="dropdown dropdown-end z-50" onClick={disableScroll}>
      ...
      >
        <svg
          ...
          className={`h-8 w-8 ${
            !mobileCtx.darkNav
              ? "fill-secondary hover:fill-primary"
              : "fill-primary hover:fill-darker"
          }`}
        >
      ...
      <div
        tabIndex={0}
        className="dropdown-content z-10 absolute top-0 right-0 menu bg-opacity-95 font-display -m-4 text-darker bg-neutral text-4xl uppercase overscroll-contain"
      >
        <div className="absolute top-4 right-6" onClick={handleClick}>
          <svg
            viewBox="0 0 1024 1024"
            fill="currentColor"
            height="1em"
            width="1em"
            className="fill-primary hover:fill-darker cursor-pointer h-10 w-10"
          >
        ...
        <div className="flex flex-col justify-center items-center h-screen w-screen pb-28 divide-y-[1px] divide-darker">
          <NavLink
            onClick={handleClick}
